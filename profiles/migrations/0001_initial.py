# Generated by Django 3.1.4 on 2021-03-10 13:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('male', 'Male'), ('female', 'Female'), ('others', 'Others')], max_length=50, null=True, verbose_name='gender')),
                ...
                ('card', models.CharField(blank=True, choices=[('silver', 'Silver'), ('gold', 'Gold'), ('Prepaid', 'Prepaid')], max_length=50, null=True, verbose_name='card')),
                ('country', django_countries.fields.CountryField(max_length=2)),
                ('street_address', models.CharField(blank=True, max_length=70, null=True, verbose_name='street address')),
